  ...
  return (
    <div className="min-h-[60vh] flex flex-col items-center justify-center px-4">
      ...
      <div className="w-full max-w-md flex justify-end mt-8">
        <Card 
          className="cursor-pointer transition-all hover:shadow-lg hover:ring-2 hover:ring-purple-500 hover:bg-purple-50 w-32"
        ...
        >
          <CardHeader className="text-center py-3 px-2">
            ...
            <CardTitle className="text-sm">Inflite</CardTitle>
