...
export default function CompletedTab({ completions }: CompletedTabProps) {
    ...
    return (
      <div className="text-center py-12">
        ...
        <p className="text-gray-500">
          Completed contractor courses will appear here.
        </p>
      </div>
    );
  }
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-2 flex">
                    <div className="flex items-center text-sm text-gray-500">
                      ...
                      <span className="truncate">{completion.courses.title}</span>
                    </div>
                  </div>
                  <div className="mt-2 flex items-center justify-between">
                    <div className="flex items-center text-sm text-gray-500 space-x-4">
                      <div className="flex items-center">
                        ...
                        <span>{completion.sites.name}</span>
                      </div>
                      <div className="flex items-center">
                        <svg className="flex-shrink-0 mr-1.5 h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3a4 4 0 118 0v4m-4 7l-3-3m6 0l-3 3" />
                        </svg>
                      ...
                      {completion.final_score && (
                        <div className="flex items-center">
                          ...
                          <span>{completion.final_score}% Score</span>
                        </div>
                      )}
                    </div>
                  </div>
