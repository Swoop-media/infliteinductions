      ...
      {!isCompleted && (
        <div className="mt-6 flex justify-end">
          <Button 
            ...
            className="min-w-[160px] px-6 py-3 text-base font-semibold bg-blue-600 hover:bg-blue-700 text-white shadow-lg hover:shadow-xl transition-all duration-200 animate-pulse disabled:animate-none disabled:opacity-50 disabled:cursor-not-allowed"
            size="lg"
          >
            {isSaving ? (
